...
class AdiveryImpl {
  ...
  configureEventEmitter() {
    ...
    this._onRewardedLoadedSubscription = eventEmmiter.addListener(
      this.REWARD_LOADED_EVENT_NAME,
      (event) => {
    ...
    this._onRewardedShownSubscription = eventEmmiter.addListener(
      this.REWARD_SHOWN_EVENT_NAME,
      (event) => {
    ...
    this._onRewardedClickSubscription = eventEmmiter.addListener(
      this.REWARD_CLICKED_EVENT_NAME,
      (event) => {
    ...
    this._onRewardedCloseSubscription = eventEmmiter.addListener(
      this.REWARD_CLOSED_EVENT_NAME,
      (event) => {
    ...
    this._onInterstitialLoadedSubscription = eventEmmiter.addListener(
      this.INTERSTITIAL_LOADED_EVENT_NAME,
      (event) => {
    ...
    this._onInterstitialShownSubscription = eventEmmiter.addListener(
      this.INTERSTITIAL_SHOWN_EVENT_NAME,
      (event) => {
    ...
    this._onInterstitialClickSubscription = eventEmmiter.addListener(
      this.INTERSTITIAL_CLICKED_EVENT_NAME,
      (event) => {
    ...
    this._onInterstitialCloseSubscription = eventEmmiter.addListener(
      this.INTERSTITIAL_CLOSED_EVENT_NAME,
      (event) => {
    ...
    this._onAppOpenLoadedSubscription = eventEmmiter.addListener(
      this.APP_OPEN_LOADED_EVENT_NAME,
      (event) => {
    ...
    this._onAppOpenShownSubscription = eventEmmiter.addListener(
      this.APP_OPEN_SHOWN_EVENT_NAME,
      (event) => {
    ...
    this._onAppOpenClickSubscription = eventEmmiter.addListener(
      this.APP_OPEN_CLICKED_EVENT_NAME,
      (event) => {
    ...
    this._onAppOpenCloseSubscription = eventEmmiter.addListener(
      this.APP_OPEN_CLOSED_EVENT_NAME,
      (event) => {
    ...
    this._onErrorSubscription = eventEmmiter.addListener(
      this.ON_ERROR_EVENT_NAME,
      (event) => {
        if (this._onError) {
